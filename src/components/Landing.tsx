  ...
  return (
    <div className='h-screen flex flex-col gap-4 justify-center items-center'>
      ...
      <div className='md:hidden flex flex-col justify-center items-center mb-4'>
        ...
        <div className='text-5xl text-[#53C0D3] dark:text-[#98E4FF] font-bold'>Mess Menu</div>
        <div className='text-4xl'>on the go</div>
      </div>
      <Link href='/details'>
        <button
          className="dark:bg-[#98E4FF] md:dark:bg-white bg-black text-white dark:text-black text-center font-extrabold py-3 px-12 rounded-md">
          Get Started
        </button>
      </Link>
    </div>
